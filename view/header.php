    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary" id="navbar">
        ...
        <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item"><a class="nav-link" aria-current="page" href="?c=Bus&m=index">Manajemen armada</a></li>
            </ul>
            <a class="btn btn-warning" id="login_btn" href="?c=Auth&m=logout">Logout</a>
        </div>
    </nav>
    </nav>
</div>
